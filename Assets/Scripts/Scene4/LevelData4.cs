...
public class LevelData4 : MonoBehaviour
{
    private static LevelData4 _instance;
    public static LevelData4 Instance { get { return _instance; } }
    ...
    {
        LevelData4.Instance.level = Level.Easy;
        InitLevelData();
    }

    public void SetNormalLevel()
    {
        LevelData4.Instance.level = Level.Normal;
        InitLevelData();
    }

    public void SetHardLevel()
    {
        LevelData4.Instance.level = Level.Hard;
        InitLevelData();
    }
